...
`tests/test_text_exporter.py`/`tests/test_docx_exporter.py`. Currently 114
tests total (113 fast + the same 1 gated test) after later sessions'
additions, most recently `tests/test_searchable_pdf_exporter.py` (8 tests,
see the `SearchablePDFExporter` entry above).
